...
// read on. Both n and address could get upto 500 billion with over 200 random tests.
// If you try to store the addresses of 500 billion houses in a list then you will run
// out of memory and the tests will crash. This is not a kata problem so please don't
// post an issue. Similarly if the tests don't complete within 12 seconds then you also fail.
